...
abstract class OfferRepository {
  ...
  Future<Result<bool, Failure>> validateOffer(String offerId, String productId);
  Future<Result<Offer, Failure>> createOffer(Offer offer);
  Future<Result<Offer, Failure>> updateOffer(Offer offer);
  Future<Result<void, Failure>> deleteOffer(String offerId);
}

/// AppNotification entity for notification domain
