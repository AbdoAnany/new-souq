...
//       ),
//       floatingActionButton: orderStream.when(
//         data: (order) {
//           final authState = ref.watch(authProvider);
//           final currentUser = authState.value;
//           final isAdminOrEmployee = currentUser?.isAdminOrEmployee ?? false;
//
...
//               onRefresh: () async {
//                 ref.invalidate(orderStreamProvider(orderId));
...
//                               SizedBox(height: 8.h),
//                               Text(
//                                 '${order.shippingAddress.country},${order.shippingAddress.city}, ${order.shippingAddress.state}, ${order.shippingAddress.postalCode}, ${order.shippingAddress.street}',
//                                 style: theme.textTheme.bodyMedium?.copyWith(
//                                   fontSize: ResponsiveUtil.fontSize(
//                                       mobile: 14, tablet: 15, desktop: 16),
//                                 ),
...
//
//                     // Action buttons
//                     // Update Order button (for pending/confirmed orders)
...
//                               MaterialPageRoute(
//                                 builder: (context) =>
//                                     OrderUpdateScreen(order: order),
//                               ),
//                             );
//
//                             // Show success message and refresh order data if updated
...
//                               );
//
//                               // Comprehensive refresh with loading indicator
//                               try {
//                                 // Show loading
//                                 ScaffoldMessenger.of(context).showSnackBar(
//                                   const SnackBar(
...
//                                 );
//
//                                 // Invalidate the specific order stream to force refresh
//                                 ref.invalidate(orderStreamProvider(orderId));
//
//                                 // Refresh the main orders provider
//                                 await ref
...
//                                 final _ =
//                                     ref.refresh(orderStreamProvider(orderId));
//
//                                 // Small delay to ensure Firestore has updated
//                                 await Future.delayed(
//                                     const Duration(milliseconds: 500));
//                               } catch (e) {
//                                 print('Error refreshing order state: $e');
//                                 if (context.mounted) {
//                                   ScaffoldMessenger.of(context).showSnackBar(
//                                     const SnackBar(
//                                       content: Text(
//                                           'Order updated but display may not reflect changes immediately'),
...
//                   );
//
//                   // Refresh state after cancellation with loading indicator
//                   try {
//                     ScaffoldMessenger.of(context).showSnackBar(
//                       const SnackBar(
//                         content: Row(
...
//                     final _ = ref.refresh(orderStreamProvider(orderId));
//
//                     // Small delay to ensure Firestore has updated
//                     await Future.delayed(const Duration(milliseconds: 500));
//                   } catch (refreshError) {
//                     print('Error refreshing after cancellation: $refreshError');
//                   }
//                 }
//               } catch (e) {
//                 if (context.mounted) {
